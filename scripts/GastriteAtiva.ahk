...
Mask_GastriteAtiva() {
    ...
    g.AddText("xm y+10 w180", "Intensidade do infiltrado")
    ...
    OnOK(*) {
        ...
        Send "^b"
        SendText "`n. Mucosa de " loc " exibindo infiltrado inflamatório misto " infil ", " dist ", associado a ligeira reação epitelial.`n. Atrofia: " atrofia ".`n. Metaplasia intestinal: " linhaMI ".`n. A pesquisa de "
        Send "^i"
