...
Mask_RimNefrectomiaTotal() {
    ...
    BuildText() {
		...
		txt .= "`n"
		txt .= "Parênquima renal não neoplásico: `n"
		txt .= ". Compartimento glomerular: dentro dos limites histológicos da normalidade `n"
		txt .= ". Compartimento túbulo-intersticial: dentro dos limites histológicos da normalidade `n"
		txt .= ". Compartimento vascular: dentro dos limites histológicos da normalidade `n"
