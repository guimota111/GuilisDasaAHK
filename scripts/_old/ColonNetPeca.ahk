; =========================================================
; Cólon/Reto — NET bem diferenciado (peça)
; Arquivo: scripts\ColonNetPeca.ahk
; Função chamada no menu: Mask_ColonNetPeca()
...
Mask_ColonNetPeca() {
    ...
    g := Gui("+AlwaysOnTop +MinSize", "Máscara — Cólon/Reto — NET bem diferenciado (peça)")
    g.MarginX := 12
    g.MarginY := 12
