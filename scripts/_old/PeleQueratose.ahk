; =========================================================
; Pele — Queratose
; Arquivo: scripts\PeleQueratose.ahk
; Função chamada no menu: Mask_PeleQueratose()
...
Mask_PeleQueratose() {
    ...
    g := Gui("+AlwaysOnTop +MinSize", "Máscara — Pele — Queratose")
    g.MarginX := 12
    g.MarginY := 12
    ...
    ddlTipo := g.AddDropDownList("x+8 w520 Choose1", [
        ...
        "seborreica incipiente",
        "actínica",
        "actínica hiperqueratótica",
        "actínica acantolítica",
        "actínica bowenoide"
    ])
